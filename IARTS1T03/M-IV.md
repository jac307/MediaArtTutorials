...
# <span style="color: darkred;">Module IV — Hybrid Design Project Proposal</span>
### Group Work
...
You may discuss ideas related to:

- hybrid media design
- spatial storytelling
- feminist or decolonial approaches
- non-linear narrative
- sound-based environments
...
**3 projects will be selected** to be realized for the **Final Showcase**.
...
- **+3 points** for project selection
- **Up to +7 additional points individually**, based on:
  - collaboration with the instructor
  - participation in testing and refinement sessions
  - presenting the work during the showcase
