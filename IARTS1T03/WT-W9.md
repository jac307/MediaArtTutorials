...
# <span style="color: darkred;">W9 - Multi-Channel Installation Design — Part 1 (Concept + Sound)</span>
...
- **1–2 corresponding lights per group of objects** (labeled `L1`, `L2`, `L3`, etc.)   
