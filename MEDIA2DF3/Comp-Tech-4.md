...
<figure style="width: 100%; margin: auto;">
  <img src="imgs/23.jpg" style="width: 100%; height: auto;" alt="Examples from previous Composition Techniques IV activities">
...
- **Scale:** Enlarge or reduce individual letters or parts of letters.
- **Weight:** Create differences between heavy, light, dense, and open forms.
- **Spacing:** Compress, separate, overlap, or interrupt letters.
- **Direction:** Rotate, tilt, curve, ascend, descend, or redirect the word.
- **Proportion:** Stretch, compress, widen, narrow, or distort letterforms.
- **Repetition:** Repeat letters, fragments, shapes, or typographic structures.
- **Cropping:** Allow parts of letters to move outside the format.
- **Fragmentation:** Cut, divide, remove, or reorganize parts of letterforms.
...
<div class="video-wrapper">
  <iframe
    ...
    title="Expressive typography tutorial"
...
Select words with enough conceptual possibilities to support substantial manipulation of their letterforms.
...
The sketches may be created by hand or digitally.
...
|---|---|
| Learning Test PDF | `Lastname-Firstname-CompTech4-LearningTest.pdf` |
