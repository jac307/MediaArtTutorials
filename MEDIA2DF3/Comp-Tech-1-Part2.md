...
<div class="gestalt-principles-grid">
  ...
  <figure class="gestalt-principle-card">
    <img
      src="imgs/principle-anomaly.png"
      alt="Example showing one form that differs from an otherwise consistent visual system"
      loading="lazy"
    >
  ...
  <figure class="gestalt-principle-card">
    <img
      src="imgs/principle-concentration.png"
      alt="Example showing repeated forms distributed from sparse areas to densely grouped areas"
      loading="lazy"
    >
  ...
  <figure class="gestalt-principle-card">
    <img
      src="imgs/principle-texture.png"
      alt="Example showing visible surface variation created through repeated marks and physical material"
      loading="lazy"
    >
  ...
  <figure class="gestalt-principle-card">
    <img
      src="imgs/principle-contrast.png"
      alt="Example showing strong differences in scale, value, shape, direction, and texture"
      loading="lazy"
    >
  ...
  <figure class="gestalt-principle-card">
    <img
      src="imgs/principle-space.png"
      alt="Example showing forms organized to create flat, illusory, or conflicting spatial relationships"
      loading="lazy"
    >
...
<div class="gestalt-principles-grid">
  ...
  <figure class="gestalt-principle-card">
    <img
      src="imgs/samara-surface-activity.png"
      alt="Examples showing surfaces changed through marks, density, direction, texture, and material variation"
      loading="lazy"
    >
  ...
  <figure class="gestalt-principle-card">
    <img
      src="imgs/samara-breaking-space.png"
      alt="Examples showing forms and lines crossing, touching, dividing, and moving beyond the boundaries of a format"
      loading="lazy"
    >
  ...
  <figure class="gestalt-principle-card">
    <img
      src="imgs/samara-arranging-form.png"
      alt="Examples showing forms organized through alignment, clustering, separation, overlap, and hierarchy"
      loading="lazy"
    >
...
> **Source:** Samara, T. (2007). “Seeing Form and Space.” In *Design Elements: A Graphic Style Manual* (pp. 58–65). Rockport Publishers.
...
Use a different grid structure for each file. The grid should organize the placement, alignment, spacing, concentration, and movement of the repeated super-units.
...
Save the original file immediately after scanning:

- `Lastname-Firstname-CompTech1-Part2-Texture.tif`
...
- Convert the grid structure into Illustrator guides unless it is intentionally visible.
...
- Confirm that the original margin guides remain present.
...
| Original unedited scan | `Lastname-Firstname-CompTech1-Part2-Texture.tif` |
