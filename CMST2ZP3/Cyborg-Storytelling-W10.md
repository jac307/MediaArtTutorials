...
<h1 style="color: darkred;">W10-11: Define the Project, Finalize Visual Materials, and Begin Pictarize Prototyping</h1>  
...
- Final version of your individual **Research Report** and collective **Brainstorming Document** from [W9: Final Research Report + AI Data Poisoning Workflow](Cyborg-Storytelling-W9.md){:target="_blank"}     
...
- **Concept Description (3–4 sentences):**
  - What speculative world your story explores  
  - How cyborg theory, retro-futurism, or BIPOC futurism is integrated  
  - What emotional or cultural experiences the viewer will engage with  
- **Narrative/Structural Format:** Choose and describe one:
  - *Linear:* A single narrative in sequence  
  - *Modular:* Standalone scenes or fragments  
  - *Speculative Archive:* A collection of images, artifacts, memories  
  - *Looped/Cyclical:* Repeating or evolving stories and media
...
In the same shared doc, under **“Materials + Task Distribution”**, outline:

### 1. Group Planning
- **Final List of Materials:** Your story must combine:
  - **Digital media**: Video, 3D models, text, GIFs  
  - **Analogue media**: Scanned illustrations, photographs, collages, textiles, handwritten notes  
- **Updated Moodboard:** Show textures, colors, visual tone  
- **Division of Labour:** Assign tasks clearly—each member must create **one digital** and **one analogue** material  
