...
| Member 3 | Assigned task | Assigned area | Required revision or material | Assigned preparation task |
| Member 4, if applicable | Assigned task | Assigned area | Required revision or material | Assigned preparation task |
...
- Prepare any instructions that would normally be available to the audience.
- Identify what the group wants to learn from the test.
- Decide who will facilitate, observe, record feedback, and document the session.
...
Complete one uninterrupted viewing, run-through, or interaction before asking questions. Do not provide interpretive context or explain the project beforehand. Provide only the instructions necessary to experience the work safely and as intended.

After each participant experiences the work, ask:

1. What did you notice first?
2. How did you understand what to see, hear, do, or follow?
3. What ideas, questions, emotions, or relationships did the work suggest?
4. Which element most strongly shaped your interpretation?
5. Was anything confusing, disconnected, inaccessible, or unnecessary?
6. What would you want to experience more clearly or fully?
...
- Date and format of the test
- Number of participants
- Participants’ relationship to the project, without unnecessary identifying information
- Questions the group wanted to investigate
- Observation notes
...
- Revised concept sketch, storyboard, score, spatial plan, or interface plan
- **Technological Research: Version 1**
- **First Artistic Prototype: Version 1**
- Work-in-progress description and documentation
- Artistic and academic research
- Audience-test observations and responses
- Feedback previously received from the instructor or class
...
| Area | Intended direction | Evidence from the prototype and audience test | Finding | Required change |
|---|---|---|---|---|
| Concept and EDI concern | What should the work investigate or communicate? | What did participants notice or overlook? | What is clear, unclear, simplified, or contradictory? | Retain, clarify, revise, add, or remove |
| Research connection | Which ideas or contexts inform the project? | Where are they visible in the artistic decisions? | Is the connection meaningful and specific? | Strengthen, clarify, contextualize, or revise |
| Artist or collective connection | Which strategies are translated, questioned, or extended? | Where can these relationships be experienced? | Does the project create a dialogue rather than imitate? | Retain, strengthen, or revise |
| Form and structure | How should the parts work together? | Where did attention, pacing, sequence, or coherence succeed or fail? | What relationships are effective or disconnected? | Reorder, connect, reduce, expand, or revise |
...
- The three strongest elements to retain
- The three most important problems to address
- Any difference between the group’s intention and the audience’s experience
- Any research connection that needs to become more visible or precise
- Any element that is technically successful but artistically unnecessary
- Any missing context, instruction, or accessibility support
- Any part of the scope that should be reduced rather than rushed
...
- The interpretation is productively supported by the artwork
- The response reveals a meaningful ambiguity
- The audience lacked necessary information or instructions
- The artistic choices contradict the intended concept
- The research connection exists in the proposal but is not present in the work

The goal is not to eliminate ambiguity or require one correct interpretation. The goal is to make the project’s structure, context, and artistic decisions intentional enough to support meaningful audience engagement.

Include the completed table and central findings in the group findings PDF.
...
Add one row for each change:

| Priority | Finding or problem | Evidence | Required change | Assigned member or members | Deadline | Evidence of completion |
|---|---|---|---|---|---|---|
| Required, Important, or Optional | What needs attention? | What evidence supports this finding? | What specific action will be completed? | Full name(s) | Date and time | How will completion be confirmed? |

Use the following priorities:

| Priority | Meaning |
|---|---|
| Required | The change is necessary for the concept, audience experience, accessibility, research connection, or prototype to function |
| Important | The change strengthens clarity, coherence, presentation, or the connection between the research and artwork |
| Optional | The change adds refinement if sufficient time remains |

Complete all **Required** changes before beginning Optional changes.

For Prototype Version 2:

- Replace all placeholders with the materials intended for the project.
- Complete the main media, objects, text, code, interactions, performance material, or other required content.
- Resolve missing citations, credits, permissions, and consent.
- Prepare any instructions and accessibility supports required for the audience.
- Integrate the unfamiliar technology into the artwork rather than presenting it as a separate demonstration.
...
Prototype Version 2 must:

- Present the complete current structure of the project
- Include the materials and content required for the intended artwork
- Replace the placeholders used in Prototype Version 1
- Integrate the unfamiliar technology or technique into the audience experience
...
- [ ] The prototype has a clear entry point for the audience.
- [ ] Instructions can be understood without a group member explaining every step.
- [ ] The complete sequence, interaction, performance, or audience path can be experienced.
- [ ] All required materials are present and placeholders have been replaced.
- [ ] The connection between the concept, research, artistic strategies, and technology is visible in the work.
...
- The complete setup
- Important details, materials, screens, or interfaces
...
2. **Audience test**
   ...
   - Observation notes
   - Summary of audience responses
   - Relevant documentation when appropriate and consented to

3. **Prototype findings**
   - Completed prototype-analysis table
   - Three strongest elements to retain
   - Three most important problems to address
   - Differences between the group’s intentions and the audience’s experience
   - Research connections that need to become clearer or more precise
   - Missing instructions, context, accessibility supports, or materials
   - Elements that should be reduced, revised, replaced, or removed

4. **Revision and production plan**
   - Completed prioritized-change table
   - Responsibilities assigned to each group member
   - Internal deadlines
   - Evidence used to confirm that each required change was completed
   - Explanation of any element removed or reduced because it could not be completed responsibly
...
6. **References and credits**
   ...
   - Media, software, datasets, tools, and external materials
   - Image and artwork credits
   - Consent or permission information when required

Name the file:

`P2-Version3-Group#-Prototype-Findings.pdf`
...
- The most important finding from the audience test
- The main changes made after analyzing Prototype Version 1
...
- Three to five images showing the revised prototype
- At least one image showing the complete work or overall setup
- Important details, materials, screens, interfaces, or interactions
- The unfamiliar technology or technique in use
- The intended audience perspective when relevant
- A stable link to the prototype when it cannot be experienced directly on the page

Each image must include:

- A brief caption explaining what it shows
...
- [ ] We used the heading **Artistic Prototype: Version 2**.
- [ ] Earlier proposals, research, and prototype versions remain unchanged.
- [ ] The explanation of changes is 100–150 words.
- [ ] The explanation connects the revisions to the audience findings and research.
- [ ] The gallery contains three to five relevant images.
- [ ] Every image includes a caption and alt text.
- [ ] Embedded media and external links work without requesting access.
- [ ] External images, artworks, media, and source materials are credited.
- [ ] We obtained consent for identifiable documentation.
- [ ] We did not include student numbers or private testing information.
...
- Read the complete [Prototype Critique and Feedback Session instructions](P2-Prototype-Critique.md).
- Create a presentation containing no more than three slides.
- Prepare a one-minute introduction to the project.
- Select an excerpt, demonstration, or guided experience of the prototype lasting no more than four minutes.
- Prepare one question on which the group would particularly like feedback.
- Bring the prototype and all required equipment, files, materials, cables, and adapters.
- Save the slides and prototype files on the computer that the group will use.
- Open and test the slides, prototype, media, and links before class.
...
Complete the requirements below. One group member must submit the group findings PDF through Avenue to Learn and update Webador on behalf of the group.

| Item | Required filename or action |
|---|---|
| Group findings PDF | Submit `P2-Version3-Group#-Prototype-Findings.pdf` through Avenue to Learn |
| Webador update | Add **Artistic Prototype: Version 2**, including the 100–150-word explanation of changes and required documentation |
| Artistic Prototype: Version 2 | Include a stable link or access instructions in the findings PDF and on Webador; no separate prototype file is required unless requested |
| Prototype critique slides | Prepare no more than three slides and bring them on the group’s computer for the following critique session; do not submit them through Avenue unless instructed |

Replace `#` with the assigned group number.

Before submitting, confirm that:

- [ ] The findings PDF contains all audience-testing notes, prototype findings, and revision decisions.
- [ ] The filename includes the correct group number.
- [ ] The prototype link opens without requesting access.
- [ ] All required materials are complete and placeholders have been replaced.
- [ ] Webador includes **Artistic Prototype: Version 2**.
- [ ] The Webador explanation of changes is 100–150 words.
- [ ] The Webador images include captions, alt text, and credits when required.
- [ ] All embedded media and external links work.
