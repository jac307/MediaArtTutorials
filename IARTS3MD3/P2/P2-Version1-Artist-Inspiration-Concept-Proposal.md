...
- Individual artistic and academic research notes
- An iteration map showing what the group will retain, revise, remove, or add from the previous proposal
- A primary unfamiliar technology or technique and one backup option
- A 250–350-word concept proposal
- One visual development page
...
- Link to the Webador profile
- Names of the Project 1 profile authors
- Title and brief summary of the existing research-creation proposal
- Why the group selected this profile
...
- What question or issue guides the proposal?
- Which part of the artist's practice shaped it?
- What artistic strategy, medium, method, or audience relationship does it use?
- What is already clear or promising?
...
- Research at least three artworks or projects.
- Include the two works discussed on the Webador page.
- Include at least one additional work not discussed on the Webador page.

For each assigned work, record:
...
| Research connection | How the work may inform, challenge, or complicate the existing proposal |
...
| Element | Decision | Reason informed by research |
|---|---|---|
| Central question or theme | Retain, revise, remove, or add | Explain the decision |
| Artistic strategy or method | Retain, revise, remove, or add | Explain the decision |
| Medium or format | Retain, revise, remove, or add | Explain the decision |
| Technology or technique | Retain, revise, remove, or add | Explain the decision |
| Audience or participation | Retain, revise, remove, or add | Explain the decision |
| Site or presentation context | Retain, revise, remove, or add | Explain the decision |
| Ethical or accessibility approach | Retain, revise, remove, or add | Explain the decision |
