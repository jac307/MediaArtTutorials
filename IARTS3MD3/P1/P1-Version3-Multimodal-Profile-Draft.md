...
In Version 3, each pair will revise the research completed in Version 2, write the critical analysis for the profile, develop a preliminary research-creation proposal, and prepare a printed research poster. Use the instructor's feedback to decide what needs to be corrected, clarified, expanded, or removed.
...
Turn the detailed outline from Version 2 into a concise **500–700-word critical analysis**.
...
<details class="tutorial-section" id="research-creation-proposal">
  ...
  <summary>
    ...
    <span class="section-title">2. Develop a preliminary research-creation proposal</span>

    <span class="section-description">

      Translate an idea, method, or question from the research into an original artistic direction that may be developed further.
...
As a pair, identify one strategy, method, question, or tension from the selected artist or collective that could inform an original artwork.
...
Create a digitally designed research poster that communicates the main direction of the profile. The poster should provide enough information to understand the project without reproducing the complete written entry.
...
- Establish a clear visual hierarchy using headings, subheadings, images, and short sections.

- Use readable type sizes and sufficient contrast.
...
- Check the printed file for legibility, colour, image quality, and cropping.
