...
This is an initial proposal. Your research direction may change as you read, discuss the work, and receive feedback.

## What your pair will complete
...
- A source map containing eight sources
...
Taking the lead means completing the initial research and notes for that artwork. Both partners must review the complete document, understand the full research direction, and be able to explain the source and artwork choices.

Do not divide the project into two separate halves. Revise the document together so that it reads as one project.

## Complete the assignment in three stages

### Stage 1: Choose the artist and define the research direction
...
- **One main research question** that states the central focus of the profile
...
The written steps above provide the same instructions as the video.

### Stage 3: Prepare and review the submission

#### Review the complete document together
...
Submit one PDF per pair. Put the following information in this order:
