...
## Objective  
In this session, you will build on your individual research by sharing insights with your partner, identifying thematic and conceptual connections, and drafting a **collaborative analysis** of your chosen artist/collective. This draft will form the foundation of your curatorial text.

By the end of this session, you will have:  
- Shared key takeaways from your research.  
- Selected **two artworks/projects** for in-depth reference and analysis.  
- Produced a 300–400 word **draft analysis** in a shared document.
...
- Access to your annotated bibliography and collected media/documentation  
...
4. **Plan Your Collaborative Analysis**  
   ...
   - Use the following recommended structure to outline your draft in a new section called **"Analysis Structure"**:
     ...
     **Body Paragraphs (200–250 words)**  
     - One paragraph per partner, each analyzing one artwork.  
...
➡️ Save as **PDF**  
📄 Filename: `Group-#-FurtherNotes.pdf`  
...
Each partner writes **150–180 words** for their assigned artwork.   
- Include:  
...
- Draft **Opening** and **Closing** sections.  
  - Divide the work so that each partner drafts one section (40–60 words each).  
...
|-------------------------------------------|----------------------------------------|---------------|
| Group Brainstorming Notes                 | `Group-#-FurtherNotes.pdf`             | One per group |
