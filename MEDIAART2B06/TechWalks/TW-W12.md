...
<figure class="media-card">
  <img
    src="imgs/135.png"
    alt="Excerpts from Jessica A. Rodríguez's curriculum vitae showing organized professional sections"
  >
  <figcaption>
...
<figure class="media-card">
  <img
    src="imgs/136.png"
    alt="Excerpts from a design portfolio showing a consistent visual layout"
  >
  <figcaption>
...
<figure class="media-card">
  <img
    src="imgs/137.png"
    alt="Excerpts from an artistic portfolio showing project images and descriptions"
  >
  <figcaption>
...
<figure class="media-card">
  <img
    src="imgs/139.png"
    alt="Excerpts from the afrontaciones project work-sample document"
  >
  <figcaption>
...
<figure class="media-card">
  <img
    src="imgs/140.jpeg"
    alt="Example of a professional application letter written for a sessional-instructor position"
  >
  <figcaption>
