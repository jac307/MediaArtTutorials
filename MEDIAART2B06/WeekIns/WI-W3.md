...
![Example of a static outdoor scene](imgs/07.jpg)
...
<details class="tutorial-section">
  <summary>
    ...
    <span class="section-description">
      Book and confirm the camera, lens, support, audio, and exposure tools required by your group.
    </span>
  </summary>

<div class="section-content" markdown="1">

Each group of three is responsible for booking, transporting, monitoring, and returning its equipment.

Coordinate with your group before submitting bookings to avoid duplicate reservations.
...
<fieldset class="equipment-checklist">
  ...
  <label class="checklist-item">
    ...
    <span>
      ...
      Use one camera for recording and keep a compatible backup available in case of battery, SD card, or equipment problems.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>Assigned lens</strong>
      Book the lens that provides the assigned focal length of approximately <code>24 mm</code>, <code>35 mm</code>, or <code>50 mm</code>.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>One large DSLR tripod</strong>
      Use a stable Manfrotto tripod or another approved support for the complete recording.
    </span>
  </label>
  ...
  <label class="checklist-item">
    ...
    <span>
      ...
      Include the shotgun microphone, camera mount adapter, audio cable, and outdoor wind protection.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>One ZOOM H4n recorder</strong>
      Include the recorder, SD card, batteries or power supply, headphones, and outdoor wind protection.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>One pair of headphones</strong>
      Use headphones to monitor the ZOOM H4n and evaluate the recorded sound.
    </span>
  </label>
  ...
  <label class="checklist-item">
    ...
    <span>
      ...
      Use a white or grey balance card to establish a fixed white balance under the actual outdoor light.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>Charged batteries and formatted SD cards</strong>
      Confirm that both the primary and backup equipment have sufficient power and storage capacity.
    </span>
  </label>
  ...
  <label class="checklist-item">
    <input type="checkbox">
    <span>
      <strong>Cables, adapters, windscreens, and accessories</strong>
      Confirm that all required audio cables, mounts, memory cards, batteries, and wind protection are included.
    </span>
  </label>
</fieldset>

> Record the identifying number of every booked item. Each piece of equipment must be returned to the bag or case with the matching number.
